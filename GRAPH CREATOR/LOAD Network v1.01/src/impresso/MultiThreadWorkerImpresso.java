    ...
    public void run() {
        ...
        while ( (newspaper_year_id = hub.getContentItemID()) != null) {
            ...
            try {
                ...
                if(RUNTIME_PROMPT)
                    System.out.println(threadNum + " - Content item : " +(System.nanoTime() - start_time) + " ns");
                ...
                if(RUNTIME_PROMPT)
                    System.out.println(threadNum + " - Inject : " +(System.nanoTime() - start_time) + " ns");
                ...
                if(RUNTIME_PROMPT)
                    System.out.println(threadNum + " - Sort : " +(System.nanoTime() - start_time) + " ns");
                ...
                if(RUNTIME_PROMPT)
                    System.out.println(threadNum + " - Get : " +(System.nanoTime() - start_time) + " ns");
                ...
                if(RUNTIME_PROMPT)
                    System.out.println(threadNum + " - Create : " +(System.nanoTime() - start_time) + " ns");
            ...
            if(RUNTIME_PROMPT)
                System.out.println(threadNum + " - Sort final : " + (System.nanoTime() - start_time) + " ns");
            ...
            if(RUNTIME_PROMPT)
                System.out.println(threadNum + " - Annotation : " +(System.nanoTime() - start_time) + " ns");

            try {
                hub.writeEdges(edges);
                if(RUNTIME_PROMPT)
                    System.out.println(threadNum + " - write : " +(System.nanoTime() - start_time) + " ns");
            } catch (Exception e) {
                e.printStackTrace();
            }
            System.gc();
            if(VERBOSE)
                System.out.println("Thread " + threadNum + " - Article " + articleID + " nodes and edges created in " + (System.nanoTime() - start_time) + " ns");
        }

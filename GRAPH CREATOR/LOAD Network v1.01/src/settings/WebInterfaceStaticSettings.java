 ...
 */
public class WebInterfaceStaticSettings {
	...
	public static String MongoCollection_EntityLookup = "nodesEntityLookup";
	...
	public static String ci_Page_url = "url";               // a page should either have a wikipedia ID or a URL, not both
	...
	public static String ci_Entity_fullLabel = "full"; // non-abbreviated label (used only in lookup collection)

	// COLLECTION Entity Lookup: mongoDB field identifier
	public static String ci_Lookup_id = "entity_id";
	public static String ci_Lookup_type = "type";
	public static String ci_Lookup_senDegree = "sentence_degree";
	public static String ci_Lookup_label = "label";
	public static String ci_Lookup_fullLabel = "full";
	public static String ci_Lookup_description = "description";
	public static String ci_Lookup_score = "score";					// this is not in the DB but a text query meta score!
	...
	public static String target_MongoCollection_EntityLookup = "nodesEntityLookup";
	...
	// minimum length for label components in lookup table
	public static int minLabelComponentLength = 3;
	...
	public static int abortTokenInterval = 10000;
